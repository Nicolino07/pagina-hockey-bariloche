...
from app.routers.public.planteles_equipos_public import router as planteles_equipos_public_router
from app.routers.admin.planteles_equipos_admin import router as planteles_equipos_admin_router
