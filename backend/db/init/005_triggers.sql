...
-- Designación de árbitros: las reglas (rol vigente, torneo propio, club propio)
-- son una advertencia confirmable manejada en la aplicación, no un bloqueo de
-- la base. Ver migración 0038.
